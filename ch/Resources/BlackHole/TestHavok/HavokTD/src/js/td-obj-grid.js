...
_TD.a.push(function (TD) {
	...
	// Reference property, or the related properties of multiple instances conflict
		...
		_init: function (cfg) {
			...
			this.passable_flag = 1; // 0: not through; 1: Available through
			this.build_flag = 1;// 0: cannot be built; 1: can be built; 2: Built
			this.building = null;
			this.caculatePos();
		},
		...
		render: function () {
			...
			if (this.is_entrance || this.is_exit) {
				...
				ctx.fillStyle = this.is_entrance ? "#232121" : "#232121";
				ctx.beginPath();
