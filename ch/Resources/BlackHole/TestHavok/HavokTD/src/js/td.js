...
var _TD = {
	...
	init: function (td_board, is_debug) {
		...
		var i, TD = {
			version: "1.0.2", //English Version naming specification Reference: http://FLSgames.com
			is_debug: !!is_debug,
			is_paused: true,
			...
			start: function () {
				...
				this.mode = "normal"; // Mode is divided into two types: Normal (normal mode) and build (construction mode)
